...
import pacman.controllers.navya_kuchibhotla.DFS_Controller;
import pacman.controllers.navya_kuchibhotla.AStar_Controller;
import pacman.controllers.navya_kuchibhotla.Simulated_Annealing_Controller;
import pacman.controllers.navya_kuchibhotla.MinMax_Controller;
import pacman.controllers.navya_kuchibhotla.Evolution_Strategy_Controller;
import pacman.controllers.navya_kuchibhotla.Genetic_Algorithm_Controller;
import pacman.controllers.navya_kuchibhotla.K_Nearest_Controller;
import pacman.controllers.navya_kuchibhotla.Final_Submission_Controller;
...
//		exec.runGameTimed(new MinMax_Controller(),new StarterGhosts(),visual);
//		exec.runGameTimed(new Evolution_Strategy_Controller(),new StarterGhosts(),visual);
//		exec.runGameTimed(new Genetic_Algorithm_Controller(),new StarterGhosts(),visual);
//		exec.runGameTimed(new K_Nearest_Controller(),new StarterGhosts(),visual);
		exec.runGameTimed(new Final_Submission_Controller(),new StarterGhosts(),visual); 
